...
import {Mutation as Mutation_2, NodePatchList} from '@sanity/mutate'
import {
...
import type {ArrayOptions, PreviewValue, SanityDocument as SanityDocument_2} from '@sanity/types'
...
export declare function useOptimisticActor(): MutatorActor | EmptyActor

/**
 * @public
 */
export declare const VisualEditing: FunctionComponent<VisualEditingOptions>
