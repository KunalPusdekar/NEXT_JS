...
const _withworkstore = require("../server/async-storage/with-work-store");
...
async function buildAppStaticPaths({ dir, page, distDir, dynamicIO, configFileName, segments, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, isAppPPRFallbacksEnabled, buildId }) {
    ...
    const routeParams = await (0, _withworkstore.withWorkStore)(ComponentMod.workAsyncStorage, {
        page,
    ...
    const fallbackMode = dynamicParams ? supportsRoutePreGeneration ? supportsPPRFallbacks ? _fallback.FallbackMode.PRERENDER : _fallback.FallbackMode.BLOCKING_STATIC_RENDER : undefined : _fallback.FallbackMode.NOT_FOUND;
    let result = {
        fallbackMode,
...
async function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, dynamicIO, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, nextConfigOutput, cacheHandler, pprConfig, isAppPPRFallbacksEnabled, buildId }) {
