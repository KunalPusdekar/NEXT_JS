...
export declare function isMiddlewareFilename(file?: string): file is "middleware" | "src/middleware";
export declare function isInstrumentationHookFilename(file?: string): file is "instrumentation" | "src/instrumentation";
...
export declare function buildAppStaticPaths({ dir, page, distDir, dynamicIO, configFileName, segments, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, isAppPPRFallbacksEnabled, buildId, }: {
    dir: string;
    page: string;
    dynamicIO: boolean;
    configFileName: string;
...
export declare function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, dynamicIO, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, nextConfigOutput, cacheHandler, pprConfig, isAppPPRFallbacksEnabled, buildId, }: {
    dir: string;
    page: string;
    distDir: string;
    dynamicIO: boolean;
