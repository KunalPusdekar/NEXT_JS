...
async function collectBuildTraces({ dir, config, distDir, edgeRuntimeRoutes, staticPages, nextBuildSpan = new _trace.Span({
    ...
    const runTurbotrace = async function() {
        ...
        if (!(bindings == null ? void 0 : bindings.isWasm) && typeof bindings.turbo.startTrace === 'function') {
            ...
            let turbotraceFiles;
            turboTasksForTrace = bindings.turbo.createTurboTasks(distDir, false, (((_config_experimental_turbotrace = config.experimental.turbotrace) == null ? void 0 : _config_experimental_turbotrace.memoryLimit) ?? _constants.TURBO_TRACE_DEFAULT_MEMORY_LIMIT) * 1024 * 1024);
