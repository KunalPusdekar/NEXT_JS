...
class AppRouteRouteModule extends _routemodule.RouteModule {
   ...
   */ resolve(method) {
    ...
    async do(handler, actionStore, workStore, workUnitStore, implicitTags, request, context) {
           ...
           */ const prospectiveController = new AbortController();
            ...
            if ((0, _redirect.isRedirectError)(err)) {
                ...
                if (workUnitStore.type === 'request') {
                    (0, _requestcookies.appendMutableCookies)(headers, workUnitStore.mutableCookies);
                }
        ...
        if (workUnitStore.type === 'request' && (0, _requestcookies.appendMutableCookies)(headers, workUnitStore.mutableCookies)) {
    ...
    async handle(req, context) {
        ...
        const response = await this.actionAsyncStorage.run(actionStore, ()=>(0, _withrequeststore.withRequestStore)(this.workUnitAsyncStorage, requestContext, (workUnitStore)=>(0, _withworkstore.withWorkStore)(this.workAsyncStorage, staticGenerationContext, async (workStore)=>{
                    ...
                    }, async ()=>this.do(handler, actionStore, workStore, workUnitStore, implicitTags, request, context));
                })));
                ...
                case 'origin':
                    {
                        ...
                        (0, _dynamicrendering.trackDynamicDataAccessed)(workStore, workUnitStore, `nextUrl.${prop}`);
                        return _reflect.ReflectAdapter.get(target, prop, receiver);
                    }
                case 'clone':
        ...
        get (target, prop) {
            switch(prop){
                ...
                case 'formData':
                    {
                        const workUnitStore = _workunitasyncstorageexternal.workUnitAsyncStorage.getStore();
                        (0, _dynamicrendering.trackDynamicDataAccessed)(workStore, workUnitStore, `request.${prop}`);
