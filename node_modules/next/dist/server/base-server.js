...
const _prefetchcachescopes = require("./lib/prefetch-cache-scopes");
const _cachescope = require("./async-storage/cache-scope");
            ...
            responseGenerator = async (...args)=>{
                ...
                if (this.renderOpts.dev) {
                    ...
                    if (!cache && !isPrefetchRSCRequest && (routeModule == null ? void 0 : routeModule.definition.kind) === _routekind.RouteKind.APP_PAGE && !isServerAction) {
                        ...
                        delete req.headers[_approuterheaders.RSC_HEADER];
                        delete req.headers[_approuterheaders.NEXT_ROUTER_PREFETCH_HEADER];
                    }
                }
                return (0, _cachescope.runWithCacheScope)({
                    cache
