...
const _cachelife = require("./cache-life");
...
function generateCacheEntry(workStore, outerWorkUnitStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn) {
    ...
    return (0, _cleanasyncsnapshotexternal.runInCleanSnapshot)(generateCacheEntryWithRestoredWorkStore, workStore, outerWorkUnitStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn);
}
function generateCacheEntryWithRestoredWorkStore(workStore, outerWorkUnitStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn) {
    ...
    return _workasyncstorageexternal.workAsyncStorage.run(workStore, generateCacheEntryWithCacheContext, workStore, outerWorkUnitStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn);
}
function generateCacheEntryWithCacheContext(workStore, outerWorkUnitStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn) {
    ...
    const cacheStore = {
        ...
        revalidate: _cachelife.defaultCacheLife.revalidate,
        explicitRevalidate: undefined,
        tags: null
    };
    return _workunitasyncstorageexternal.workUnitAsyncStorage.run(cacheStore, generateCacheEntryImpl, workStore, outerWorkUnitStore, cacheStore, clientReferenceManifest, cacheHandler, serializedCacheKey, encodedArguments, fn);
}
