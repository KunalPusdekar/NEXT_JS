 ...
 */
export declare function markCurrentScopeAsDynamic(store: WorkStore, workUnitStore: undefined | WorkUnitStore, expression: string): void;
/**
 ...
 */
export declare function trackDynamicDataAccessed(store: WorkStore, workUnitStore: undefined | WorkUnitStore, expression: string): void;
export declare function abortOnSynchronousDynamicDataAccess(route: string, expression: string, prerenderStore: PrerenderStoreModern): void;
/**
...
export declare function isRenderInterruptedReason(reason: string): reason is "NEXT_PRERENDER_INTERRUPTED";
export declare function accessedDynamicData(dynamicTracking: DynamicTrackingState): boolean;
export declare function formatDynamicAPIAccesses(dynamicTracking: DynamicTrackingState): string[];
/**
...
export declare function trackAllowedDynamicAccess(route: string, thrownValue: Error, componentStack: string, dynamicTracking: DynamicTrackingState): void;
export declare function throwIfDisallowedDynamic(workStore: WorkStore, dynamicTracking: DynamicTrackingState): void;
export {};
