...
async function readPartialManifest(distDir, name, pageName, type = 'pages') {
    ...
    if (!(0, _fs.existsSync)(manifestPath) && page.endsWith('/route')) {
        ...
        const metadataPage = (0, _turbopackutils.addRouteSuffix)((0, _turbopackutils.addMetadataIdToRoute)((0, _turbopackutils.removeRouteSuffix)(page.replace(/\/sitemap\.xml\/route$/, '/sitemap/route'))));
        manifestPath = _path.posix.join(distDir, `server`, type, type === 'middleware' || type === 'instrumentation' ? '' : type === 'app' ? metadataPage : (0, _getassetpathfromroute.default)(metadataPage), name);
    }
