...
import { trackDynamicDataAccessed, createDynamicTrackingState, getFirstDynamicReason, isPrerenderInterruptedError } from '../../app-render/dynamic-rendering';
 ...
 */ export class AppRouteRouteModule extends RouteModule {
   ...
   */ resolve(method) {
    ...
    async do(handler, actionStore, workStore, workUnitStore, implicitTags, request, context) {
        ...
        if (workUnitStore.type === 'request' && appendMutableCookies(headers, workUnitStore.mutableCookies)) {
    ...
    async handle(req, context) {
        ...
        const response = await this.actionAsyncStorage.run(actionStore, ()=>withRequestStore(this.workUnitAsyncStorage, requestContext, (workUnitStore)=>withWorkStore(this.workAsyncStorage, staticGenerationContext, async (workStore)=>{
