...
function assignDefaults(dir, userConfig, silent) {
    var _defaultConfig_experimental, _defaultConfig_experimental1, _result_experimental, _result_experimental1, _result_experimental2, _result_experimental_serverActions, _result_experimental3, _result_experimental_turbo, _result_experimental4, _result_experimental_turbo1, _result_experimental5, _result_experimental_turbo2, _result_experimental6, _result_devIndicators, _result_experimental7;
    ...
    if ((_defaultConfig_experimental1 = defaultConfig.experimental) == null ? void 0 : _defaultConfig_experimental1.pprFallbacks) {
        Log.warn(`\`experimental.pprFallbacks\` has been defaulted to \`true\` because \`__NEXT_EXPERIMENTAL_PPR\` was set to \`true\` during testing.`);
    }
    const result = {
        ...defaultConfig,
        ...config
    ...
    if ((result == null ? void 0 : (_result_experimental4 = result.experimental) == null ? void 0 : (_result_experimental_turbo = _result_experimental4.turbo) == null ? void 0 : _result_experimental_turbo.root) && !isAbsolute(result.experimental.turbo.root)) {
    ...
    if ((result == null ? void 0 : result.outputFileTracingRoot) && !(result == null ? void 0 : (_result_experimental5 = result.experimental) == null ? void 0 : (_result_experimental_turbo1 = _result_experimental5.turbo) == null ? void 0 : _result_experimental_turbo1.root)) {
        dset(result, [
            'experimental',
            'turbo',
            'root'
    ...
    if (!(result == null ? void 0 : result.outputFileTracingRoot) || !(result == null ? void 0 : (_result_experimental6 = result.experimental) == null ? void 0 : (_result_experimental_turbo2 = _result_experimental6.turbo) == null ? void 0 : _result_experimental_turbo2.root)) {
        let rootDir = findRootDir(dir);
        if (rootDir) {
            var _result_experimental_turbo3, _result_experimental8;
            ...
            if (!(result == null ? void 0 : (_result_experimental8 = result.experimental) == null ? void 0 : (_result_experimental_turbo3 = _result_experimental8.turbo) == null ? void 0 : _result_experimental_turbo3.root)) {
                dset(result, [
                    'experimental',
                    'turbo',
                    'root'
