...
import { RSC_HEADER, NEXT_RSC_UNION_QUERY, NEXT_ROUTER_PREFETCH_HEADER, NEXT_DID_POSTPONE_HEADER, NEXT_URL, NEXT_ROUTER_STATE_TREE_HEADER, NEXT_IS_PRERENDER_HEADER } from '../client/components/app-router-headers';
...
import { CACHE_ONE_YEAR, INFINITE_CACHE, NEXT_CACHE_TAGS_HEADER, NEXT_RESUME_HEADER } from '../lib/constants';
...
import { runWithCacheScope } from './async-storage/cache-scope';
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && isAppPageRouteModule(routeModule);
        ...
        let responseGenerator = async ({ hasResolved, previousCacheEntry, isRevalidating })=>{
            ...
            if (process.env.NEXT_RUNTIME !== 'edge' && !this.minimalMode && fallbackMode !== FallbackMode.BLOCKING_STATIC_RENDER && staticPathKey && !didRespond && !isPreviewMode && isDynamic && (isProduction || !staticPaths || !isPageIncludedInStaticPaths)) {
                ...
                if (isPagesRouteModule(components.routeModule) && !isNextDataRequest) {
                ...
                } else if (isRoutePPREnabled && this.nextConfig.experimental.pprFallbacks && isAppPageRouteModule(components.routeModule) && !isRSCRequest) {
                    // We use the response cache here to handle the revalidation and
                    // management of the fallback shell.
                    ...
                    async ()=>doRender({
                            ...
                            // here.
                            postponed: undefined,
                            fallbackRouteParams: isProduction ? getFallbackRouteParams(pathname) : null
                        }), {
        ...
        if (this.nextConfig.experimental.dynamicIO) {
            ...
            responseGenerator = async (...args)=>{
                ...
                if (this.renderOpts.dev) {
                    ...
                    if (!cache && !isPrefetchRSCRequest && (routeModule == null ? void 0 : routeModule.definition.kind) === RouteKind.APP_PAGE && !isServerAction) {
                ...
                return runWithCacheScope({
                    cache
                }, ()=>originalResponseGenerator(...args)).finally(()=>{
                    if (this.renderOpts.dev) {
        ...
        if (ssgCacheKey && !this.minimalMode && isRoutePPREnabled && this.nextConfig.experimental.pprFallbacks && ((_cacheEntry_value = cacheEntry.value) == null ? void 0 : _cacheEntry_value.kind) === CachedRouteKind.APP_PAGE && cacheEntry.isFallback && !isOnDemandRevalidate) {
