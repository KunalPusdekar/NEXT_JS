...
export async function buildAppStaticPaths({ dir, page, distDir, dynamicIO, configFileName, segments, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled, isAppPPRFallbacksEnabled, buildId }) {
    ...
    const routeParams = await withWorkStore(ComponentMod.workAsyncStorage, {
        page,
    ...
    const fallbackMode = dynamicParams ? supportsRoutePreGeneration ? supportsPPRFallbacks ? FallbackMode.PRERENDER : FallbackMode.BLOCKING_STATIC_RENDER : undefined : FallbackMode.NOT_FOUND;
    let result = {
        fallbackMode,
...
export async function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, dynamicIO, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, nextConfigOutput, cacheHandler, pprConfig, isAppPPRFallbacksEnabled, buildId }) {
