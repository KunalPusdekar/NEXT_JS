...
import { STATIC_STATUS_PAGE_GET_INITIAL_PROPS_ERROR, PUBLIC_DIR_MIDDLEWARE_CONFLICT, MIDDLEWARE_FILENAME, PAGES_DIR_ALIAS, INSTRUMENTATION_HOOK_FILENAME, RSC_PREFETCH_SUFFIX, RSC_SUFFIX, NEXT_RESUME_HEADER } from '../lib/constants';
...
import { ACTION_HEADER, NEXT_ROUTER_PREFETCH_HEADER, RSC_HEADER, RSC_CONTENT_TYPE_HEADER, NEXT_ROUTER_STATE_TREE_HEADER, NEXT_DID_POSTPONE_HEADER } from '../client/components/app-router-headers';
...
export function createStaticWorker(config, onActivity) {
...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, runLint = true, noMangling = false, appDirOnly = false, turboNextBuild = false, experimentalBuildMode, traceUploadUrl) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            await recordFrameworkVersion("15.0.0-canary.183");
            ...
            async function turbopackBuild() {
                var _config_experimental, _config_experimental_turbo, _config_experimental1, _config_experimental_turbo1, _config_experimental_turbo2;
                if (!IS_TURBOPACK_BUILD) {
                ...
                const project = await bindings.turbo.createProject({
                    ...
                    persistentCaching: (_config_experimental_turbo1 = config.experimental.turbo) == null ? void 0 : _config_experimental_turbo1.persistentCaching,
                    memoryLimit: (_config_experimental_turbo2 = config.experimental.turbo) == null ? void 0 : _config_experimental_turbo2.memoryLimit
                });
