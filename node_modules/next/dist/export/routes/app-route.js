...
const _routemoduleloader = require("../../server/lib/module-loader/route-module-loader");
...
async function exportAppRoute(req, res, params, page, incrementalCache, distDir, htmlFilepath, fileWriter, experimental, buildId) {
