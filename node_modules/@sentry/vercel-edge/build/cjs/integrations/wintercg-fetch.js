...
const _winterCGFetch = ((options = {}) => {
  ...
  const _createSpanUrlMap = new utils.LRUMap(100);
  const _headersUrlMap = new utils.LRUMap(100);
...
function createBreadcrumb(handlerData) {
  ...
  if (handlerData.error) {
    ...
    const level = utils.getBreadcrumbLogLevelFromHttpStatusCode(data.status_code);
